...
RUN apt-get install -y git python2.7 python-pip libz-dev libblas3 liblapack3 liblapack-dev libblas-dev gfortran libatlas-base-dev
...
RUN cd docker-monovar/monovar/ \
    ...
    export PATH=$PATH:external/samtools \
